...
par(mfrow=c(2,4))
plot(stationary$t,stationary$k,type="l",xlab="Qs",ylab="% deviation from SS",xaxs="i",yaxs="i",lwd=2,ylim=c(-0.1,1),main="Capital (K)")
...
legend(x="topright",legend=c("Shocks", "No Shocks"),lwd=c(2.5,2.5),col=c("black", "red"), lty=c(1,1),cex=0.4,bty = "n")
plot(stationary$t,stationary$y,type="l",xlab="Qs",ylab="% deviation from SS",xaxs="i",yaxs="i",lwd=2,ylim=c(-0.1,1.5),main="Product (Y)")
...
legend(x="topright",legend=c("Shocks", "No Shocks"),lwd=c(2.5,2.5),col=c("black", "red"), lty=c(1,1),cex=0.4,bty = "n")
plot(stationary$t,stationary$i,type="l",xlab="Qs",ylab="% deviation from SS",xaxs="i",yaxs="i",lwd=2,ylim=c(-0.25,5),main="Investment (I)")
lines(impulse$t,impulse$i,col="red",lwd=2)
legend(x="topright",legend=c("Shocks", "No Shocks"),lwd=c(2.5,2.5),col=c("black", "red"), lty=c(1,1),cex=0.4,bty = "n")
plot(stationary$t,stationary$h,type="l",xlab="Qs",ylab="% deviation from SS",xaxs="i",yaxs="i",lwd=2,ylim=c(-0.1,1),main="Labor (H)")
lines(impulse$t,impulse$h,col="red",lwd=2)
legend(x="topright",legend=c("Shocks", "No Shocks"),lwd=c(2.5,2.5),col=c("black", "red"), lty=c(1,1),cex=0.4,bty = "n")
plot(stationary$t,stationary$r,type="l",xlab="Qs",ylab="% deviation from SS",xaxs="i",yaxs="i",lwd=2,ylim=c(-0.5,1.5),main="Interest rate (r)")
