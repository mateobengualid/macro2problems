...
# EXAMPLE 1: Hansen benchmark real business cycle model,
#           see Hansen, G., "Indivisible Labor and the Business Cycle,"
#           Journal of Monetary Economics, 16 (1985), 281-308.

cat('EXAMPLE 1: Hansen benchmark real business cycle model, \n');
cat('           see Hansen, G., "Indivisible Labor and the Business Cycle," \n');
...
CC = rbind(c(    -C_bar,      Y_bar,      0,        0,        -I_bar), 
	   c(0,           0,          0,        0,        I_bar),
          c(0,           -1,         1-rho,    0,        0      ),      
          c(-eta,        1,          -1,       0,        0      ),
          c(0,           rho*YK_bar, 0,        - R_bar,  0))
